...
// Maga_PictureRestoration.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMagaPictureRestorationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMagaPictureRestorationApp

CMagaPictureRestorationApp::CMagaPictureRestorationApp()
{
...
// Единственный объект CMagaPictureRestorationApp

CMagaPictureRestorationApp theApp;


// Инициализация CMagaPictureRestorationApp

BOOL CMagaPictureRestorationApp::InitInstance()
{
